        ...
        <>
          ...
          <div className="layout-bottom-sheet fixed bottom-0 left-0 right-0 z-50 rounded-t-2xl md:hidden">
            ...
            <div className="flex items-center justify-between px-5 pb-3">
              ...
              <button onClick={() => setShowMore(false)} className="p-2 rounded-lg text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] transition-colors">
                <X size={20} />
              </button>
            </div>
            ...
            {/* Footer Actions */}
            <div className="layout-bottom-sheet-footer px-3 pt-3 mt-2 space-y-1">
              {/* Theme Toggle */}
              <button
