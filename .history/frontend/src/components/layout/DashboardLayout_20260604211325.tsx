    ...
    <div className="min-h-screen dashboard-root">
      ...
      >
        <Header 
          ...
          onNavigate={setCurrentPage} 
        />
        <main className="flex-1 px-3 py-3 pb-24 sm:px-4 sm:py-4 md:px-6 md:pt-6 md:pb-6">
          <div key={currentPage} className="w-full max-w-[1200px] mx-auto animate-fade-in-up">
            {renderPage()}
          </div>
        </main>
      </div>
