...
const quickActions: FabAction[] = [
  { id: 'receipt', label: DOCUMENT_TYPE_META.receipt.label, icon: Receipt },
  { id: 'cashbill', label: DOCUMENT_TYPE_META.cashbill.label, icon: Banknote },
  { id: 'delivery', label: DOCUMENT_TYPE_META.delivery.label, icon: Truck },
  { id: 'taxinvoice', label: DOCUMENT_TYPE_META.taxinvoice.label, icon: FileText },
];
