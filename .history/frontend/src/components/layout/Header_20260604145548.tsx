...
export default function Header({ pageTitle, onNavigate }: HeaderProps) {
  ...
  return (
    <header
      className="h-[72px] border-b flex items-center justify-between px-4 md:px-6 sticky top-0 z-30 backdrop-blur-md"
      style={{
    ...
    >
      ...
      {/* Center: Search Bar */}
      <div className="hidden lg:flex items-center flex-1 max-w-[420px] mx-6">
