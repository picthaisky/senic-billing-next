...
export default function Header({ pageTitle, onNavigate }: HeaderProps) {
  ...
  return (
    <header className="layout-header flex items-center justify-between gap-3 px-4 md:px-6 sticky top-0 z-30">
      ...
      <div className="hidden md:flex items-center flex-1 max-w-[440px] mx-6">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        <div className="relative" ref={notificationsRef}>
          ...
          {showNotifications && (
            <div className="layout-profile-menu absolute right-0 top-full mt-2 w-[330px] max-w-[calc(100vw-2rem)] rounded-2xl shadow-xl border overflow-hidden animate-fade-in">
              ...
              <div className="max-h-[320px] overflow-y-auto">
                {notifications.length === 0 ? (
                  ...
                  notifications.map((n) => (
                    <div
                      key={n.id}
                      className={`group relative flex gap-3 px-4 py-3 border-b last:border-0 border-[var(--color-border)] transition-colors hover:bg-[var(--color-surface-hover)] ${n.unread ? 'is-unread' : ''}`}
                    >
                      <span
                      ...
                      <button
                        ...
                        className="focus-ring opacity-0 group-hover:opacity-100 transition-opacity text-[var(--color-text-muted)] hover:text-[var(--color-text)] rounded-md p-0.5 h-fit"
        ...
        <div className="relative ml-0.5" ref={profileMenuRef}>
          ...
          {showProfile && (
            <div className="layout-profile-menu absolute right-0 top-full mt-2 w-60 rounded-2xl shadow-xl border overflow-hidden animate-fade-in">
              {/* Header */}
