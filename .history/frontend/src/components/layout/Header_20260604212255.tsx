    ...
    <header className="layout-header sticky top-0 z-30 px-3 sm:px-4 md:px-6">
      <div className="w-full max-w-[1200px] mx-auto h-full flex items-center justify-between gap-3">
        ...
        <div className="relative" ref={notificationsRef}>
          ...
          {showNotifications && (
            <div className="layout-profile-menu layout-flyout-menu layout-notif-menu absolute right-0 top-full mt-2 w-[330px] max-w-[calc(100vw-2rem)] rounded-2xl shadow-xl border overflow-hidden">
        ...
        <div className="relative ml-0.5" ref={profileMenuRef}>
          ...
          {showProfile && (
            <div className="layout-profile-menu layout-flyout-menu layout-user-menu absolute right-0 top-full mt-2 w-60 rounded-2xl shadow-xl border overflow-hidden">
              {/* Header */}
      ...
      {showMobileSearch && (
        <div className="layout-mobile-search layout-mobile-search-panel md:hidden absolute left-0 right-0 top-full px-4 py-3 border-b z-20">
          <div className="relative w-full">
            <Search
              size={16}
              className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--color-text-muted)] pointer-events-none"
