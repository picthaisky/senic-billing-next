  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 h-16 border-b border-white/10">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold text-lg shrink-0 bg-brand-gradient">
        ...
        {!collapsed && (
          <div className="animate-fade-in">
            ...
            <p className="text-[10px] font-medium tracking-wider uppercase text-[var(--sidebar-text)]">
              Next Generation
            </p>
          </div>
        )}
