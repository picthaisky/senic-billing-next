        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`layout-sidebar-nav-item focus-ring relative w-full flex items-center gap-3 rounded-xl mb-0.5 transition-all duration-200 group ${collapsed ? 'justify-center px-0 py-2.5' : 'px-3 py-2.5'} ${isActive ? 'is-active' : ''}`}
