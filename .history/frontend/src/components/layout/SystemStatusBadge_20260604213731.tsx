    ...
    <div className="relative">
      ...
      {showDetails && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-64 rounded-xl shadow-xl border z-50 overflow-hidden animate-fade-in-up bg-[var(--color-surface-solid)] text-[var(--color-text)] border-[var(--color-border)]">
            <div className="p-3 border-b bg-[var(--color-bg-secondary)] border-[var(--color-border)]">
            ...
            <div className="p-2 max-h-64 overflow-y-auto">
              {!isConnected ? (
                ...
                components.map((c, i) => (
                  <div key={i} className="p-2 flex justify-between items-center border-b last:border-0 border-[var(--color-border)]">
                    <div>
