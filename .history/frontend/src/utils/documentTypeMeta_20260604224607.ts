export type DocumentTypeId = 'taxinvoice' | 'receipt' | 'cashbill' | 'delivery' | 'quotation';

export interface DocumentTypeMeta {
  id: DocumentTypeId;
  label: string;
  prefix: 'INV' | 'RCP' | 'CSB' | 'DLV' | 'QUO';
  color: string;
  badgeClass: string;
}
...
export const DOCUMENT_TYPE_META: Record<DocumentTypeId, DocumentTypeMeta> = {
  ...
  quotation: {
    ...
    label: 'ใบเสนอราคา',
    prefix: 'QUO',
    color: 'var(--doc-quotation)',
    badgeClass: 'badge-doc-quotation',
  },
};
