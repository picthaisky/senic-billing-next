...
const quickActions: FabAction[] = [
  { id: 'receipt', label: 'ใบเสร็จรับเงิน', icon: Receipt, color: '#16a34a' },
  { id: 'cashbill', label: 'บิลเงินสด', icon: Banknote, color: '#2563eb' },
  { id: 'delivery', label: 'ใบส่งของ', icon: Truck, color: '#9333ea' },
  { id: 'taxinvoice', label: 'ใบกำกับภาษี', icon: FileText, color: '#ea580c' },
];
